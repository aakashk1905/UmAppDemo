...
namespace Agora_RTC_Plugin.API_Example.Examples.Advanced.ScreenShare
{
    public class Test : MonoBehaviour
    {
        ...
        [ContextMenu("Prepare Capture")]
        public void PrepareScreenCapture()
        {
            Debug.Log("Prepare screen capture");
           ...
           // WinIdSelect.ClearOptions();
            ...
            Debug.Log("Screen capture reources length " +_screenCaptureSourceInfos.Length);
        ...
        public void OnStartShareBtnClick()
        {
            ...
            Test.MakeVideoView(0, "", VIDEO_SOURCE_TYPE.VIDEO_SOURCE_SCREEN);
    ...
    {
        private readonly Test _desktopScreenShare;
        private global::ScreenShare screenShare;

        internal UserEventHandler(Test desktopScreenShare)
        {
            _desktopScreenShare = desktopScreenShare;
        }

        public UserEventHandler(global::ScreenShare screenShare)
        {
        ...
        public override void OnLeaveChannel(RtcConnection connection, RtcStats stats)
        {
            ...
            Test.DestroyVideoView(connection.localUid);
        }
        ...
        public override void OnUserJoined(RtcConnection connection, uint uid, int elapsed)
        {
            ...
            Test.MakeVideoView(uid, _desktopScreenShare.GetChannelName(), VIDEO_SOURCE_TYPE.VIDEO_SOURCE_REMOTE);
        }
